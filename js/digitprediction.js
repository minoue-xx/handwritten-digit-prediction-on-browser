...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 593056,
    DYNAMIC_BASE = 5835936,
    DYNAMICTOP_PTR = 592896;
...
var wasmBinaryFile = 'digitprediction.wasm';
...
var asmGlobalArg = {};
var asmLibraryArg = { "__lock": ___lock, "__unlock": ___unlock, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "memory": wasmMemory, "table": wasmTable };
var asm = createWasm();
...
var real__digitprediction_initialize = asm["digitprediction_initialize"];
asm["digitprediction_initialize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__digitprediction_initialize.apply(null, arguments);
};

var real__digitprediction_terminate = asm["digitprediction_terminate"];
asm["digitprediction_terminate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__digitprediction_terminate.apply(null, arguments);
};
...
var real__digitPredictFcn = asm["digitPredictFcn"];
asm["digitPredictFcn"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__digitPredictFcn.apply(null, arguments);
};
...
var _digitprediction_initialize = Module["_digitprediction_initialize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["digitprediction_initialize"].apply(null, arguments)
};

var _digitprediction_terminate = Module["_digitprediction_terminate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["digitprediction_terminate"].apply(null, arguments)
};
...
var _digitPredictFcn = Module["_digitPredictFcn"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["digitPredictFcn"].apply(null, arguments)
};
